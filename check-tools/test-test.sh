...
# test-test.sh
# 
# Test XML test files for schema conformity
#
...
TFILELIST=`find ../examples/test -type f -name "*-nothing.xml"`
ALLXMLFILES=`find ../examples/test -type f -name "*.xml"`
...
echo "==========================================="
echo "Validation Test Suite -- Content Test Files"
echo "==========================================="
echo ""

START=`date`

testxmlvalid "$TFILELIST"
